...
void main() {
  ...
  group('Group Navigation Integration Tests', () {
    ...
    test('Group document can be fetched for navigation', () async {
      ...
      expect(
        ...
        equals('A group for testing navigation'),
      );
      expect(groupDoc.data()?['createdBy'], equals(userId));
      expect(groupDoc.data()?['memberIds'], contains(userId));
    });

    test('Group stream provides real-time updates for details page', () async {
      await createTestUserAndGroup();
    ...
    test('Group members can be fetched for details page', () async {
      await createTestUserAndGroup();
    ...
    test('Group games can be queried for details page', () async {
      await createTestUserAndGroup();
    ...
    test('Navigating to non-existent group returns null', () async {
      await createTestUserAndGroup();
