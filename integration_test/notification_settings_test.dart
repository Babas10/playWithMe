...
void main() {
  ...
  group('Notification Preferences Reading', () {
    ...
    test('User without notification preferences gets default values', () async {
    ...
    test('User can read their notification preferences', () async {
      await createTestUser();
  ...
  group('Notification Preferences Toggling', () {
    ...
    test('User can toggle groupInvitations preference', () async {
    ...
    test('User can toggle gameCreated preference', () async {
      await createTestUserWithPreferences();
    ...
    test('User can toggle memberJoined preference', () async {
      await createTestUserWithPreferences();
    ...
    test('User can toggle training session notification preferences', () async {
      await createTestUserWithPreferences();
    ...
    test('Toggling one preference does not affect others', () async {
      await createTestUserWithPreferences();
  ...
  group('Notification Preferences Persistence', () {
    ...
    test('Notification preferences are saved to Firestore correctly', () async {
      await createTestUser();
      ...
      final prefsToSave = {
        ...
        'groupSpecific': {'group-123': true, 'group-456': false},
      };
    ...
    test('Preferences persist after sign out and sign in', () async {
      await createTestUser();
    ...
    test('Group-specific notification settings are saved correctly', () async {
      await createTestUser();
  ...
  group('Quiet Hours Settings', () {
    ...
    test('User can enable quiet hours', () async {
      await createTestUser();
    ...
    test('User can disable quiet hours', () async {
      await createTestUser();
    ...
    test('User can update quiet hours time range', () async {
      await createTestUser();
  ...
  group('Complete Notification Preferences Update', () {
    ...
    test('User can save complete notification preferences object', () async {
      await createTestUser();
    ...
    test('Updating preferences replaces existing values', () async {
      await createTestUser();
