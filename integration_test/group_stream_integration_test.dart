...
void main() {
  ...
  group('Group Stream Integration Tests', () {
    ...
    test('Groups stream emits data when group is created', () async {
    ...
    test('Groups stream emits update when group is modified', () async {
      await createTestUser();
    ...
    test('Groups stream emits when multiple groups are added', () async {
      await createTestUser();
    ...
    test('Groups stream filters by memberIds correctly', () async {
      await createTestUser();
    ...
    test('Groups stream handles group deletion', () async {
      await createTestUser();
