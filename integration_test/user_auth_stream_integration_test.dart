...
void main() {
  ...
  group('User Auth Stream Integration Tests', () {
    test('Auth state stream emits null when no user is signed in', () async {
    ...
    test('Auth state stream emits user when signed in', () async {
      final auth = FirebaseAuth.instance;
    ...
    test('Auth state stream emits null when user signs out', () async {
      final auth = FirebaseAuth.instance;
    ...
    test('User ID token changes stream emits on profile update', () async {
      final auth = FirebaseAuth.instance;
    ...
    test('Current user reflects authentication state correctly', () async {
      final auth = FirebaseAuth.instance;
    ...
    test('Auth state persists user data correctly', () async {
      final auth = FirebaseAuth.instance;
