...
void main() {
  ...
  group('Invitation Decline Flow', () {
    test('User can decline invitation and status updates correctly', () async {
    ...
    test('Declined invitation removes from pending queries', () async {
    ...
    test('User can decline multiple invitations independently', () async {
      // 1. Create users
      final admin = await FirebaseEmulatorHelper.createCompleteTestUser(
        email: 'admin@test.com',
        password: 'password123',
    ...
    test('Only invited user can decline their invitation', () async {
      // 1. Create users
      final admin = await FirebaseEmulatorHelper.createCompleteTestUser(
        email: 'admin@test.com',
        password: 'password123',
    ...
    test('User cannot set invalid status when declining', () async {
      // 1. Create users and group
      final admin = await FirebaseEmulatorHelper.createCompleteTestUser(
        email: 'admin@test.com',
        password: 'password123',
