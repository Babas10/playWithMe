  ...
  group('Friend Request Send Flow', () {
    test(
      ...
      () async {
        ...
        final searchResult2 = await searchCallable.call({
          'email': 'user2@test.com',
        });
    ...
    test('User cannot send friend request to themselves', () async {
    ...
    test('User cannot send duplicate friend request', () async {
      // 1. Create two test users
    ...
    test('Sent friend request appears in sender\'s sent requests', () async {
      // 1. Create two test users
      final user1 = await FirebaseEmulatorHelper.createCompleteTestUser(
        email: 'user1@test.com',
        password: 'password123',
    ...
    test('User cannot send friend request to non-existent user', () async {
      // Create and sign in as user
      await FirebaseEmulatorHelper.createCompleteTestUser(
        email: 'user@test.com',
        password: 'password123',
