...
void main() {
  ...
  group('GroupDetailsPage Widget Tests', () {
    ...
    group('Tab Layout', () {
      ...
      testWidgets('Members tab shows Invite Member entry for admins',
          (tester) async {
        await tester.pumpWidget(createTestWidget());
        await tester.pumpAndSettle();
      ...
      testWidgets('Members tab shows Invite with Link entry for admins',
          (tester) async {
        await tester.pumpWidget(createTestWidget());
        await tester.pumpAndSettle();

        // Scroll down to ensure the lazy list builds the invite entries
      ...
      testWidgets('Activities tab shows Create Training Session button',
          (tester) async {
        await tester.pumpWidget(createTestWidget());
        await tester.pumpAndSettle();
