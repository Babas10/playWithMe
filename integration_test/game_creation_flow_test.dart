...
void main() {
  ...
  group('Game Creation Flow', () {
    ...
    test('User can create a game within a group', () async {
    ...
    test('Game creator is automatically added as a player', () async {
      await createTestGroupAndUser();
    ...
    test('Game with optional description stores correctly', () async {
      await createTestGroupAndUser();
    ...
    test('Game stores location with address correctly', () async {
      await createTestGroupAndUser();
    ...
    test('Game scheduled time is stored correctly', () async {
      await createTestGroupAndUser();
      ...
      final gameDoc = await gameRef.get();
      final storedScheduledAt = (gameDoc.data()?['scheduledAt'] as Timestamp)
          .toDate();
    ...
    test('Multiple games can be created in same group', () async {
      await createTestGroupAndUser();
    ...
    test('Game with player limits stores correctly', () async {
      await createTestGroupAndUser();
    ...
    test('Game status defaults to scheduled', () async {
      await createTestGroupAndUser();
    ...
    test('Games are linked to correct group', () async {
      await createTestGroupAndUser();
