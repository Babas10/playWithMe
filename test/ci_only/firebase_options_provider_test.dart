    ...
    () {
      ...
      group('getFirebaseOptions', () {
        test('returns dev options when environment is dev', () {
          ...
          expect(
            ...
            equals(CITestHelper.getExpectedStorageBucket(Environment.dev)),
          );
          expect(
            options.authDomain,
            equals(CITestHelper.getExpectedAuthDomain(Environment.dev)),
          );
        });
        ...
        test('returns prod options when environment is prod', () {
          ...
          expect(
            options.projectId,
            equals(CITestHelper.getExpectedProjectId(Environment.prod)),
          );
          expect(
            options.storageBucket,
            equals(CITestHelper.getExpectedStorageBucket(Environment.prod)),
          );
          expect(
            options.authDomain,
            equals(CITestHelper.getExpectedAuthDomain(Environment.prod)),
          );
        });
      });
      ...
      group('Firebase options consistency', () {
        ...
        test('each environment has unique project identifiers', () {
          ...
          final projectIds = [devOptions.projectId, prodOptions.projectId];
