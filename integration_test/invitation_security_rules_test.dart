...
void main() {
  ...
  group('Security Rule Validation - Invitation Creation', () {
    ...
    test('Non-group-member cannot create invitations', () async {
      // 1. Create users
      final admin = await FirebaseEmulatorHelper.createCompleteTestUser(
        email: 'admin@test.com',
        password: 'password123',
  ...
  group('Security Rule Validation - Invitation Reading', () {
    test('Users cannot read other users invitations', () async {
      // 1. Create users
      final admin = await FirebaseEmulatorHelper.createCompleteTestUser(
        email: 'admin@test.com',
        password: 'password123',
    ...
    test('Group admin cannot read invitations they sent', () async {
    ...
    test('Invited user CAN read their own invitations', () async {
      // 1. Create users
      final admin = await FirebaseEmulatorHelper.createCompleteTestUser(
        email: 'admin@test.com',
        password: 'password123',
  ...
  group('Security Rule Validation - Invitation Deletion', () {
    test('Invited user can delete their own invitations', () async {
    ...
    test('Inviter (admin) can delete invitations they sent', () async {
      // 1. Create users and invitation
      final admin = await FirebaseEmulatorHelper.createCompleteTestUser(
        email: 'admin@test.com',
        password: 'password123',
    ...
    test('Other users cannot delete invitations', () async {
      // 1. Create users and invitation
      final admin = await FirebaseEmulatorHelper.createCompleteTestUser(
        email: 'admin@test.com',
        password: 'password123',
